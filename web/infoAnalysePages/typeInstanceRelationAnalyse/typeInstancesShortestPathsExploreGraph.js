...
$(document).ready(function() {
    ...
    var restURL=APPLICATION_REST_SERVICE_CONTEXT+"/ws/typeInstanceAnalyseService/typeInstancesShortestPathsExplore/"+discoverSpaceName+"/"+relationableAId+"/"+relationableBId+"/"+pathNumber+"/";
    $.ajax({
        url: restURL
    }).then(function(data) {        
